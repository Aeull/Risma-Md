...
exports.smsg = (conn, m, hasParent) => {
    ...
    if (m.message) {
        ...
        m.mtype = (!['senderKeyDistributionMessage', 'messageContextInfo'].includes(mtype[0]) && mtype[0]) || // Terkadang pesan di depan
            (mtype.length >= 3 && mtype[1] !== 'messageContextInfo' && mtype[1]) || // Terkadang pesan di tengah panjang tipe lebih besar dari atau sama dengan 3!
